...
const OptionHistoryManager = () => {
  ...
  const handleFileUpload = async (event) => {
    ...
    try {
      ...
      await api.upload('/api/option-history/upload-csv', formData);
  ...
  return (
    <div style={commonStyles.appContainer}>
      <div style={commonStyles.surface}>
        ...
        <h2 style={{ marginBottom: '8px' }}>Option History Manager</h2>
        <p style={{ color: '#666', marginBottom: '32px' }}>
          Select a CSV file to upload historical options data to the Quant database.
        </p>
...
export default OptionHistoryManager;